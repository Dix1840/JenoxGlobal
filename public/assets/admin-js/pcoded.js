...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (mobile_collapse_over) {
    mobile_collapse_over.addEventListener('click', function (e) {
      ...
      if (sidebar) sidebar.classList.add('mob-sidebar-active');
      if (overlay) overlay.classList.add('active');
    });
  }

  // Sidebar close button (X)
  var sidebar_close_btn = document.querySelector('#sidebar-close');
  if (sidebar_close_btn) {
    sidebar_close_btn.addEventListener('click', function (e) {
      e.preventDefault();
      closeMobileSidebar();
    });
  }
  ...
  if (mobileSearchToggle && mobileSearchBar) {
    mobileSearchToggle.addEventListener('click', function (e) {
      ...
      var inp = mobileSearchBar.querySelector('input');
      if (inp) inp.focus();
    });
  }
